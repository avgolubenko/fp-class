...
-- тип функции: 3 параметра типа Double и результат того же типа
...
{-
   ...
   расстановку скобок:
    ...
    x							<interactive>:46:1: Not in scope: `x'
...
-- (объясните смысл типовой аннотации: Функция Double имеет входной и результирующий аргумент типа a, который принадлежит классу типов Num)
double :: Num a => a -> a
double a = 2 * a
